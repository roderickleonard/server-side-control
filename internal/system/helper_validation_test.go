...
func TestValidateHelperAction(t *testing.T) {
	tests := []struct {
		...
		{name: "allowed mysql query", action: "mysql.execute_query", wantErr: false},
		{name: "allowed mysql service inspect", action: "mysql.inspect_service", wantErr: false},
		{name: "allowed mysql service configure", action: "mysql.configure_service", wantErr: false},
		{name: "allowed mysql service install", action: "mysql.install_service", wantErr: false},
		{name: "allowed mysql service upgrade", action: "mysql.upgrade_service", wantErr: false},
		{name: "allowed mysql service logs", action: "mysql.service_logs", wantErr: false},
		{name: "allowed mysql admin query", action: "mysql.execute_admin_query", wantErr: false},
		{name: "allowed mysql export", action: "mysql.export_database", wantErr: false},
